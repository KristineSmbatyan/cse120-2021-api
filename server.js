...
const uri =
  "mongodb+srv://Kristine:Smbatyan02@cluster0.hpyx6.mongodb.net/myFirstDatabase?retryWrites=true&w=majority";
...
app.post('/data/update', function (req, res) {
  ...
  .then(client => {
    let id = req.body.id;
    const query = { "_id": ObjectId(id)};
    client.db('cse120-2021-db').collection('books').update(query)
      .then(result => {
        console.log(result)
